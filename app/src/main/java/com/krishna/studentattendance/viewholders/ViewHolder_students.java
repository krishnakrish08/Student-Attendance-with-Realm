package com.krishna.studentattendance.viewholders;
...
import com.krishna.studentattendance.bottomSheet.StudentBottomSheet;
...
public class ViewHolder_students extends RecyclerView.ViewHolder{
    ...
    RealmResults<StudentsList> mList;
    ...
    public ViewHolder_students(@NonNull final View itemView, Activity MainActivity, RealmResults<StudentsList> list, final String roomID) {
        super(itemView);
        ...
        layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                StudentBottomSheet student_edit_sheet = new StudentBottomSheet(stuName, regNo, mobileNo);
